...
function RegisterForm({ onReg }) {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="bg-yellow last:mt-[25px] w-64 rounded-lg py-5">
      ...
      {formik.errors.username && formik.touched.username && <p className="text-red text-sm mb-[15px]">{formik.errors.username}</p>}
      ...
      <label htmlFor="password" className="block text-left text-grey text-[13px] mb-3 font-medium">
        Password
      </label>
