...
<label htmlFor="username" className="block text-left text-grey text-[13px] font-medium">Username:</label>
...
<label htmlFor="email" className="block text-left text-grey text-[13px] font-medium">Email:</label>
...
<div className="relative">
  ...
  />
      ...
      <label htmlFor="password" className="block text-left text-grey text-[13px] font-medium">Password:</label>
